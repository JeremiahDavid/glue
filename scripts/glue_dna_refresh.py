...
See ``hiveflow.dna.glue_runner`` for the refresh implementation.
"""
...
def main() -> None:
    ...
    from hiveflow.dna.glue_runner import run_dna_refresh

    result = run_dna_refresh(
        source=str(args.get("HIVEFLOW_SOURCE") or "").strip(),
