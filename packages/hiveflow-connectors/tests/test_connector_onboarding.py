...
from hiveflow.connectors.onboarding.dbc import list_dbc_companies, validate_dbc_credentials
...
@patch("hiveflow.bc.auth.acquire_client_credentials_token")
@patch("hiveflow.bc.client.BCClient")
